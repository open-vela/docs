...
To understand how drivers are registered with the file system, it is necessary to first understand the relevant data structures. The definitions of these data structures are located in the[`include/nuttx/fs/fs.h`](https://github.com/open-vela/nuttx/blob/dev/include/nuttx/fs/fs.h)file.  
