...
9. **评审**：初评（9.21–9.30）→ 决赛名单公示（**50 支队伍入围**）→ 线下答辩 → 颁奖。
...
获奖者将有机会获得奖金、小米生态孵化机会、Xiaomi Watch S5、小米车模等奖励；**完赛者均可获得官方荣誉证书、社区定制周边**。

> 所有奖项奖励**不叠加发放**，按最高达标档位发放。

**主奖项**

| 奖项         | 奖励                                | 名额 | 备注         |
| ------------ | ----------------------------------- | ---- | ------------ |
| **一等奖** 🏆 | **80,000 元现金 + Xiaomi Watch S5** | 1 支 | 全场最高荣誉 |
| **二等奖** 🥈 | 40,000 元现金                       | 2 支 | 优质标杆项目 |
| **三等奖** 🥉 | 20,000 元现金                       | 5 支 | 优质创新项目 |

**专项奖**

| 奖项                 | 奖励                    | 名额 | 备注                     |
| -------------------- | ----------------------- | ---- | ------------------------ |
| 硬件生态贡献奖       | 10,000 元现金           | 2 支 | 新硬件平台适配专项荣誉   |
| 未来之星奖（高校组） | 10,000 元现金           | 5 支 | 仅限在校学生团队         |
| 未来之星奖（少年组） | 5,000 元现金            | 2 支 | 仅限 16 岁以下青少年团队 |
| AI 最佳实践奖        | 10,000 元现金           | 2 支 | 表彰 AI 开发落地标杆项目 |
| 手表应用创新奖       | 5,000 元现金            | 2 支 | 手表应用创新专项荣誉     |
| 优秀奖               | 官方证书 + 社区定制周边 | 若干 | 优质完赛创新项目         |
